  ...
  async load() {
    ...
    if (this.data.length > 0) {
      const toastInfo = {
        ...
        body: `<p>Do you want to restore the ${this.data.length} ${
          this.data.length > 1 ? 'items' : 'item'
        }<br> you had in your queue?</p><button class="btn" data-dismiss="toast" id="tasklist-btn">Restore</button><button class="btn" data-dismiss="toast">Cancel</button>`,
      };
